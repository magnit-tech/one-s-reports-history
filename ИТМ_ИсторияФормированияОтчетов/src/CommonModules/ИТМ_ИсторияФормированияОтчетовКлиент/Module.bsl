...
// 
// Параметры:
//  ЭтаФорма - ФормаКлиентскогоПриложения - Эта форма
//  КлючЗаписиРегистра - РегистрСведенийКлючЗаписи.ИТМ_ИсторияФормированияОтчетов - Ключ записи регистра
Процедура ОткрытьОтчетПоЗаписиРегистра(ЭтаФорма, КлючЗаписиРегистра) Экспорт
	...
	ФормаОтчета = ОткрытьФорму(СодержимоеЗаписи.ПолноеИмя + ".Форма", СодержимоеЗаписи, ЭтаФорма, ЭтаФорма.УникальныйИдентификатор);
