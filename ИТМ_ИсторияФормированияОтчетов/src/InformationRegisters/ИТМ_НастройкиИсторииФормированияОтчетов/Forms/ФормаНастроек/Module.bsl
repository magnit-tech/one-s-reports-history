...
&НаКлиенте
Процедура ИспользоватьИсториюФормированияОтчетовПриИзменении(Элемент)
	
	ЗаписатьКонстантуИспользования(ИспользоватьИсториюФормированияОтчетов);
...
Процедура ОбновитьЭлементыФормы(Форма)
	...
	ИспользоватьИсторию = Форма.ИспользоватьИсториюФормированияОтчетов;
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, 
		"ВсеНастройкиПодсистемы", "Доступность", ИспользоватьИсторию);
...
// Записать константу использования.
// 
// Параметры:
//  НовоеЗначение - Булево
&НаСервереБезКонтекста
Процедура ЗаписатьКонстантуИспользования(НовоеЗначение)

	Константы.ИспользоватьИсториюФормированияОтчетов.Установить(НовоеЗначение);
